...
const (
	...
	TickDelayedHigh                     = 72
	TickDelayedLow                      = 73
	TickDelayedVolume                   = 74
	TickDelayedClose                    = 75
	TickDelayedOpen                     = 76
	TickRtTrdVolume                     = 77
	TickCreditmanMarkPrice              = 78
	TickCreditmanSlowMarkPrice          = 79
	TickDelayedBidOptComp               = 80
	TickDelayedAskOptComp               = 81
	TickDelayedLastOptComp              = 82
	TickDelayedModelOptComp             = 83
	TickLastExchange                    = 84
	TickLastRegTime                     = 85
	TickFuturesOpenInterest             = 86
)
